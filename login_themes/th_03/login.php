...
<html>
    <head>
        <meta charset="utf-8">
        <title>Dashboard - More Card</title>
        <link rel="stylesheet" href="login_themes/th_03/css/style.css">
        <link rel="stylesheet" type="text/css" href="../app/bootstrap-3.3.7/css/bootstrap.css" media="all"/>
    ...
    <body>
            ...
            <div class="row">
                <div class="col-xs-12 col-sm-6 col-md-4 col-sm-offset-3 col-md-offset-4 voffset-1 voffset-b-2">
                    <div class="col-xs-12 form-outer">
                        <form action="" method="post" id="login-form" class="voffset-3">
                            ...
                            if (($_SERVER['REQUEST_METHOD'] == 'POST') && $_SESSION['key'] == $_POST['key']) {
                                ...
                                ?>
                                <div class="alert alert-info square" role="alert"><strong>Sign in</strong> to continue</div>
                                <?php
                            }
                            ...
                            <fieldset>
                                ...
                                <div class="form-group col-xs-12 text-center">
                                    ...
                                    require_once '../app/securimage/securimage.php';
                                    $options = array();
                    ...
                    <div class="col-xs-12 voffset-1">
                        <a href="../"><span class="glyphicon glyphicon-arrow-left"></span> Return to my website</a>
                    </div> 
                </div>
            </div>
        </div>
        <div class="container-fluid footer">
            <div class="row">
                <div class="col-xs-12">
                    <p>Developed by <a href="http://slwebcreations.com" target="_blank">SL Web Creations</a>. &copy; <?php echo date('Y'); ?> All rights reserved.
                        <br/>
